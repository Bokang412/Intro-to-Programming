...
// // And operator && works if both of the statements are true
...
// // Or operator || works if either of the statements is true
// if (((deliveryCity === "Anytown") && (orderPrice > 10)) || 
// (birthday === "yes")) {
//  let deliveryPrice = 0;
//  } else {
...
function placeOrder() {
    ...
    // output for the delivery price, if there is one
    if (deliveryPrice === 0) {
